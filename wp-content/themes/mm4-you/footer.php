		...
		<div class="wrapper">
			...
			<?php if ( has_nav_menu( 'footer' ) ) : ?>
				<nav id="colophon-navigation" class="footer-navigation" role="navigation">
					...
					<div id="ftr-portal"><a href="<?php echo site_url( '/employees/' ) ?>"><?php esc_html_e( 'Employee Links' ); ?></a></div>
				</nav>
			<?php endif; ?>
			<div class="site-info">
				<div class="company-info">
					...
					if ($company): ?><span class="ftr-contact cinzel"><?php echo $company; ?><br></span><?php endif;
...
<a href="https://www.mm4solutions.com/" target="_blank" id="mms">Website by Millennium Marketing Solutions</a>
